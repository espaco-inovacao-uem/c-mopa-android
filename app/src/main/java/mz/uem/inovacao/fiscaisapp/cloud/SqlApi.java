...
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.CloudObject;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.ComponentList;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.FieldSchema;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.FilterRecordRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.FilterRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.GetRecordsRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.IdsRecordRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.IdsRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.RecordResponse;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.RecordsRequest;
...
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.StoredProcRequest;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.StoredProcResponse;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.Success;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.TableSchema;
import mz.uem.inovacao.fiscaisapp.dreamfactory.model.TableSchemas;
...
public class SqlApi {
    ...
    public Resources getResources () throws ApiException {
        ...
        String path = "/sql".replaceAll("\\{format\\}","json");
    ...
    public RecordsResponse getRecordsByFilter (String table_name, String filter, Integer limit, Integer offset, String order, String fields, Boolean include_count, Boolean include_schema, String related) throws ApiException {
        ...
        // create path and map variables
        String path = "/sql/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
    ...
    // Retornava RecordsResponse
    public RecordsResponse getUser(String table_name, String ids, String filter, Integer limit, Integer offset, String order, String fields, Boolean include_count, Boolean include_schema, String id_field, String id_type, Boolean _continue, String related) throws ApiException {
        // verify required params are set
        if(table_name == null ) {
            throw new ApiException(400, "missing required params");
        }
...
//    	  return null;
    ...
    public RecordResponse getRecord (String table_name, String id, String fields, String id_field, String id_type, String related) throws ApiException {
        ...
        // create path and map variables
        String path = "/sql/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    ...
    public String createRecord (String table_name, String id, Object body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
        ...
        // create path and map variables
//    String path = "/sql/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
        String path = "/sql/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())); //.replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
        // query params
        Map<String, String> queryParams = new HashMap<String, String>();
        Map<String, String> headerParams = new HashMap<String, String>();
        ...
        try {
            String response = apiInvoker.invokeAPI(basePath, path, "POST", queryParams, body, headerParams, contentType);
            Log.d("Ultimo teste",response);

            if(response != null){
                return (String) response.substring(8, response.length()-1);
            }
            else {
                return null;
            }
    ...
    public RecordResponse replaceRecord (String table_name, String id, CloudObject body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
        if(table_name == null || id == null || body == null ) {
            throw new ApiException(400, "missing required params");
        }
    ...
    public RecordResponse updateRecord (String table_name, String id, CloudObject body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
        if(table_name == null || id == null || body == null ) {
            throw new ApiException(400, "missing required params");
        }
    ...
    public Resources getSchemas () throws ApiException {
        // create path and map variables
        String path = "/sql/_schema".replaceAll("\\{format\\}","json");
    ...
    public TableSchema describeTable (String table_name, Boolean refresh) throws ApiException {
        ...
        // create path and map variables
        String path = "/sql/_schema/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
    ...
    public FieldSchema describeField (String table_name, String field_name, Boolean refresh) throws ApiException {
        ...
        // create path and map variables
        String path = "/sql/_schema/{table_name}/{field_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "field_name" + "\\}", apiInvoker.escapeString(field_name.toString()));
    ...
    public Resources getStoredProcs () throws ApiException {
        // create path and map variables
        String path = "/sql/_proc".replaceAll("\\{format\\}","json");
    ...
    public StoredProcResponse callStoredProc(String procedure_name, String wrapper) throws ApiException {
        ...
        // create path and map variables
        String path = "/sql/_proc/{procedure_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "procedure_name" + "\\}", apiInvoker.escapeString(procedure_name.toString()));
