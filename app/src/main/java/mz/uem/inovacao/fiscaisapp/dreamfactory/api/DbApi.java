...
//    	  return null;
  ...
  public RecordResponse createRecord (String table_name, String id, CloudObject body, String fields, String id_field, String id_type, String related) throws ApiException {
    // verify required params are set
    ...
    // create path and map variables
//    String path = "/db/{table_name}/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    String path = "/db/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())); //.replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
    // query params
    Map<String, String> queryParams = new HashMap<String, String>();
    Map<String, String> headerParams = new HashMap<String, String>();
  ...
  public Resources getSchemas () throws ApiException {
    // create path and map variables
    String path = "/db/_schema".replaceAll("\\{format\\}","json");
  ...
  public TableSchema describeTable (String table_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/db/_schema/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
  ...
  public FieldSchema describeField (String table_name, String field_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/db/_schema/{table_name}/{field_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "field_name" + "\\}", apiInvoker.escapeString(field_name.toString()));
  ...
  public Resources getStoredProcs () throws ApiException {
    // create path and map variables
    String path = "/db/_proc".replaceAll("\\{format\\}","json");
  ...
  public StoredProcResponse callStoredProc(String procedure_name, String wrapper) throws ApiException {
    ...
    // create path and map variables
    String path = "/db/_proc/{procedure_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "procedure_name" + "\\}", apiInvoker.escapeString(procedure_name.toString()));
