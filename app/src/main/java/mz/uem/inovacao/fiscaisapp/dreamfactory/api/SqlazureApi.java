...
public class SqlazureApi {
  ...
  public Resources getSchemas () throws ApiException {
    // create path and map variables
    String path = "/sqlazure/_schema".replaceAll("\\{format\\}","json");
  ...
  public TableSchema describeTable (String table_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/sqlazure/_schema/{table_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString()));
  ...
  public FieldSchema describeField (String table_name, String field_name, Boolean refresh) throws ApiException {
    ...
    // create path and map variables
    String path = "/sqlazure/_schema/{table_name}/{field_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "table_name" + "\\}", apiInvoker.escapeString(table_name.toString())).replaceAll("\\{" + "field_name" + "\\}", apiInvoker.escapeString(field_name.toString()));
  ...
  public Resources getStoredProcs () throws ApiException {
    // create path and map variables
    String path = "/sqlazure/_proc".replaceAll("\\{format\\}","json");
  ...
  public StoredProcResponse callStoredProc(String procedure_name, String wrapper) throws ApiException {
    ...
    // create path and map variables
    String path = "/sqlazure/_proc/{procedure_name}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "procedure_name" + "\\}", apiInvoker.escapeString(procedure_name.toString()));
