...
public class DbsApi {
    ...
    String serviceName = "/mysql/_table";
    ...
    public RecordsResponse getRecords (String table_name, String ids, String filter, Integer limit, Integer offset, String order, String fields, Boolean include_count, Boolean include_schema, String id_field, String id_type, Boolean _continue, String related) throws ApiException {
        ...
        try {
            String response = apiInvoker.invokeAPI(basePath, path, "GET", queryParams, null, headerParams, contentType);
            if(response != null){
                Log.d("este","nao e nulo "+response.toString());
                return (RecordsResponse) ApiInvoker.deserialize(response, "", RecordsResponse.class);
    ...
    public RecordsResponse createRecord (String table_name, Object body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
        if(table_name == null || body == null ) {
            throw new ApiException(400, "missing required params");
        }
    ...
    public RecordResponse replaceRecord (String table_name, String id, Object body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
    ...
    public RecordResponse updateRecord (String table_name, String id, Object body, String fields, String id_field, String id_type, String related) throws ApiException {
        // verify required params are set
        if(table_name == null || id == null || body == null ) {
            throw new ApiException(400, "missing required params");
        }
